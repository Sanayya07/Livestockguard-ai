  ...
  return (
    ...
    >
      ...
      {file ? (
        ...
        <>
          <div
            className={`mx-auto flex h-12 w-12 items-center justify-center rounded-xl ${accent} transition-transform group-hover:scale-110`}
          >
...
interface AnalyzePageProps {
  ...
  onAnimalSelected: (animal: AnimalData) => void;
}
...
export function AnalyzePage({
  ...
  const handleAnalyze = async () => {
    ...
    formData.append('activity_level', String(activityLevel));
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * Previously the backend result was only logged and discarded.
       *
       * Now we save the entered animal details AND the backend result
       * so the next pages can use the actual animal instead of demoReport.
       */
      const animalData: AnimalData = {
        id: animalId.trim(),
        species,
        age: age.trim() === '' ? 0 : Number(age),
        temperature,
        humidity,
        activityLevel,
    ...
    <div className="mx-auto max-w-5xl space-y-5">
      ...
      <div className="flex items-start gap-3 rounded-xl border border-brand-200 bg-brand-50/60 px-4 py-3.5">
        ...
        <div>
          <p className="text-sm font-semibold text-brand-800">
            Multi-signal AI health analysis
          </p>

          <p className="mt-0.5 text-sm text-brand-700">
            LivestockGuard AI analyses visual cues, audio patterns,
            behaviour indicators, and farm-condition data to identify
            potential health risks. Results are AI-assisted prototype
            outputs and not a veterinary diagnosis.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader
          ...
          subtitle="Identify the animal you want to analyse"
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <Card>
          ...
          <div className="p-5">
            ...
            <p className="mt-3 text-xs text-ink-400">
              The system analyses body condition, posture, coat quality,
              eye/nose discharge, and movement patterns.
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="p-5">
            ...
            <p className="mt-3 text-xs text-ink-400">
              The system detects breathing rate, coughing, wheezing,
      ...
      <div className="flex flex-col items-center gap-3 pb-4">
        ...
        >
          {isAnalyzing ? 'Analyzing Animal...' : 'Analyze Animal'}
        </Button>

        {!canAnalyze && (
          <p className="text-sm text-ink-400">
            Enter an Animal ID and upload at least one image/video
            or audio file to begin analysis.
          </p>
        )}
